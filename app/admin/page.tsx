...
import type { LocalizedText, Question, QuestionOption } from '../../lib/types';
...
const emptyQuestion = (): Omit<Question, 'id'> => ({ question: emptyText(), questionImage: '', options: [emptyOption(), emptyOption()], correctAnswer: 0 });
